...
import { 
    REGISTER_FAIL, REGISTER_SUCCESS, AUTH_ERROR,
    LOGIN_SUCCESS, USER_UPDATE_INFO_SUCCESS, LOGIN_FAIL,LOGOUT,
...
export const updateProfilePassword = ({currentPassword, password}) => async dispatch => {
    ...
    setAuthToken(localStorage.token)
    try {
        await axios.patch(`${baseUrl}/api/user/customer/update/password`, body, config)
