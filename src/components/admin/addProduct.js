      ...
      const handleProductSubmit = async() => {
        ...
        if(productName.length <=0 || productDescription.length <=0 ||productPrice.length <=0||productMeasure.length <=0||productCategory.length <=0 ||  productPercent < 0 || imgSrc.length <=0){
            ...
            try {
                ...
                await axios.post(`${baseUrl}/api/user/product/add`, formDataHere, config)
            ...
            <div className="col-7">
                    ...
                    <Form onSubmit={e => e.preventDefault()}>
                        <Form.Row className="mb-2" >
                            <img alt="img" src={imgSrc} style={{height:'20rem', width:'20rem'}} className="img-thumbnail" width="100%" />
                            <Form.Group>
